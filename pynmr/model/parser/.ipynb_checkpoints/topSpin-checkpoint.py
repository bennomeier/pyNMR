...
def TopSpinSSH(self, path, exp, localPath, server, username, password, endianess = "<", debug = False):
    """This function will first copy the data from an ssh server, 
    and then initialize and return a TopSpin Object using the local data.
